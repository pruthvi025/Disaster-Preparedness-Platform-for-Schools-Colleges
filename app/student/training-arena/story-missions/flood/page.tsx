...
export default function FloodMissionPlaceholder() {
  return (
    <div className="bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">Flood in Your Town</h1>
          ...
          <div className="flex items-center justify-center gap-3 mb-8">
            ...
            <span className="px-3 py-1 rounded-full text-xs font-medium bg-indigo-50 text-indigo-700">+70 XP</span>
          </div>
